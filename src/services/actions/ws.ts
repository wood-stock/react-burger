...
interface IWsConnectionSuccessAction {readonly type: typeof WS_CONNECTION_SUCCESS, payload: any}
interface IWsConnectionErrorAction {readonly type: typeof WS_CONNECTION_ERROR, payload: any}
interface IWsConnectionClosedAction {readonly type: typeof WS_CONNECTION_CLOSED}
interface IWsGetMessageAction {readonly type: typeof WS_GET_MESSAGE, payload: any}
